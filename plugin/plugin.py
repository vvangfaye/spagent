...
- You only have 3 viewing angles to choose:
    - Left views: azimuth=-45°, elevation=0° (see scenes from right view)
    - Right views: azimuth=45°, elevation=0° (see scenes from left view)
    - Top views: azimuth=0°, elevation=60° (see scenes from top view, better capture the object relation and relatifve position of cam and objects.)
